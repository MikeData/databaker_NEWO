...
obs_file['dim_item_id_6'][obs_file['dim_item_id_6'] == 'nan'] = ''

# Quarters
obs_file['time_dim_item_id'][obs_file['dim_item_id_6'] != ''] = obs_file['dim_item_id_5'].str[0:4] + ' ' + obs_file['dim_item_id_6'].str[0:2]
obs_file['time_type'][obs_file['dim_item_id_6'] != ''] = 'Quarter'

# Years
obs_file['time_dim_item_id'][obs_file['dim_item_id_6'] == ''] = obs_file['dim_item_id_5'].str[0:4]
obs_file['time_type'][obs_file['dim_item_id_6'] == ''] = 'Year'
...
for col in ['dim_item_id_1', 'dim_item_id_2', 'dim_item_id_3', 'dim_item_id_4']:
...
for i, row in obs_file.iterrows():
        ...
        if row['dim_item_id_2'] != '':
                obs_file.ix[i, 'dim_item_id_1'] = obs_file.ix[i, 'dim_item_id_1'] + ' ' + obs_file.ix[i, 'dim_item_id_2']
        if row['dim_item_id_3'] != '':
                obs_file.ix[i, 'dim_item_id_1'] = obs_file.ix[i, 'dim_item_id_1'] + ' ' + obs_file.ix[i, 'dim_item_id_3']
        if row['dim_item_id_4'] != '':
                obs_file.ix[i, 'dim_item_id_1'] = obs_file.ix[i, 'dim_item_id_1'] + ' ' + obs_file.ix[i, 'dim_item_id_4']
                
obs_file['dimension_item_label_eng_1'] = obs_file['dim_item_id_1']


# round observations to 1 decimal point =============================----------------------------------------------#
obs_file['observation'][1:-1] = obs_file['observation'][1:-1].map(float).map(lambda x: np.round(x, 1))
