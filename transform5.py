...
obs_file['dim_item_id_4'][obs_file['dim_item_id_4'] == 'nan'] = ''

# Quarters
obs_file['time_dim_item_id'][obs_file['dim_item_id_4'] != ''] = obs_file['dim_item_id_3'].str[0:4] + ' ' + obs_file['dim_item_id_4'].str[0:2]
obs_file['time_type'][obs_file['dim_item_id_4'] != ''] = 'Quarter'

# Years
obs_file['time_dim_item_id'][obs_file['dim_item_id_4'] == ''] = obs_file['dim_item_id_3'].str[0:4]
obs_file['time_type'][obs_file['dim_item_id_4'] == ''] = 'Year'
...
for col in ['dim_item_id_1', 'dim_item_id_2']:
...
for i, row in obs_file.iterrows():
        # If 2 is not blank - concat it onto 1.
        if row['dim_item_id_2'] != '':
                obs_file.ix[i, 'dim_item_id_1'] = obs_file.ix[i, 'dim_item_id_1'].strip() + ' - ' + obs_file.ix[i, 'dim_item_id_2'].strip()
...
obs_file = tf.dismiss(obs_file, ['dim_id_2', 'dim_id_3', 'dim_id_4'])
